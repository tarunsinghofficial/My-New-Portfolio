  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-black">
        ...
        <div
          className="container mx-auto sm:px-2 md:px-2 mt-10"
          data-aos="fade-left"
          data-aos-offset="200"
          data-aos-delay="50"
        ...
        <h2
          ...
          data-aos-easing="ease-in-out"
          data-aos-once="false"
          className="dark:text-white container mx-auto sm:px-2 md:px-2 text-6xl font-bold mt-10"
        >
          Tech Stack
        </h2>
        <section
          ...
          data-aos-easing="ease-in-out"
          data-aos-once="false"
          className="container mx-auto sm:px-2 md:px-2 max-h-max mt-10"
        >
          <div className="flex flex-wrap justify-between">
            ...
            <div className="flex flex-col w-20 text-center transform transition duration-500 hover:scale-125">
              ...
              <h4 className="text-1xl dark:text-white">
                Tailwind CSS
              </h4>
            </div>
            <div className="flex flex-col w-20 text-center transform transition duration-500 hover:scale-125">
        ...
        <h2 data-aos="fade-left"
          ...
          data-aos-duration="1000"
          data-aos-easing="ease-in-out"
          data-aos-once="false" className="dark:text-white container mx-auto sm:px-2 md:px-2 text-6xl font-bold  mt-5">
          Education
        </h2>
        <section className="container mx-auto sm:px-2 md:px-2 mt-10">
          <div
            ...
            data-aos-duration="1000"
            data-aos-once="false"
            className="flex flex-col md:flex-row sm:gap-8 sm:items-center px-10 justify-between"
          >
            ...
            <div
              ...
              data-aos-duration="1000"
              data-aos-once="false"
              className="w-9/12 sm:w-fit md:w-9/12 text-left drop-shadow-md dark:drop-shadow-xl bg-bgGray dark:bg-gray-200 p-4 rounded-xl"
            >
              ...
              <h2 className="md:text-2xl lg:text-2xl">
